...
BODY = '''
    ...
    <section class="abio">
      ...
      <div class="abio-text">
        ...
        Bentley&rsquo;s Real Estate in Greater Newburyport, where nine years of
        ...
        lives in the Merrimack Valley with his wife and two children.</p>
        <ul class="alinks">
          <li><a href="https://www.linkedin.com/in/duncan-burns-545a1a353/"
                 target="_blank" rel="noopener">LinkedIn</a></li>
          <li><a href="https://www.bentleysrealestate.com/team/duncan-burns"
                 target="_blank" rel="noopener">Bentley&rsquo;s Real Estate</a></li>
          <li><a href="https://valleypatriot.com/category/op-eds-editorials/duncan-burns/"
                 target="_blank" rel="noopener">Valley Patriot columns</a></li>
          <li><a href="https://github.com/duncanburns2013-dot/Massachusetts-Data-Hub"
                 target="_blank" rel="noopener">Source repository</a></li>
        </ul>
      </div>
    </section>
...
.alinks{list-style:none;display:flex;flex-wrap:wrap;gap:8px;margin:14px 0 0;padding:0}
.alinks a{display:inline-block;font-family:var(--font-mono);font-size:10.5px;font-weight:600;
  letter-spacing:.1em;text-transform:uppercase;text-decoration:none;
  padding:6px 11px;border-radius:7px;color:var(--bay-blue);
  background:rgba(20,85,143,.08);border:1px solid rgba(20,85,143,.24);
  transition:background .2s,border-color .2s,transform .3s cubic-bezier(.19,1,.22,1)}
.alinks a:hover{background:rgba(20,85,143,.15);border-color:rgba(20,85,143,.45);
...
@media (max-width:640px){
  ...
  .alinks{justify-content:center}
  .abio-text h2{text-align:center}
}
@media (prefers-reduced-motion: reduce){ .alinks a:hover{transform:none} }
"""
...
print('links: %d | column titles: %d | feed rows: %d'
      % (s.count('class="alinks"') and len(re.findall(r'<li><a href="http', s)),
